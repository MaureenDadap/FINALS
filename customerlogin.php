...
<!-- <head>
  <title> Guest Login | Le Comscie' </title>
</head>
...
<body style="background-color:cornsilk">
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
        <h1>Hi Guest,<br> Welcome to <span style=" color: gold;" class="edit"> Le Comscie' </span></h1>
      </center>
      <br>
  ...
  <footer>
    <center>
      <p style="color:gray;">R. Bulanon & B. Katigbak Inc.</p>
    </center>
    <center>
      <p style="color:gray;">BSCS191A</p>
    </center>
  </footer>
</body>
